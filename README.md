...
- Need a way to output an array with user specified formatting. Current solution of always printing 2 decimal places will only work in certain circumstances.
